...
const Loginpage = ({history}) => {
      ...
      {/* <div className="main" style={{display: 'flex',flexDirection: 'row'}}> */}
           {/* <div className="login_ip2">
            ...
            <h2>LOGIN PAGE</h2>
            <input  className="ip_val" type="email"  name="email" value={Input.email} placeholder="email" />
            <br/>
            <br/>
            <input  className="ip_val" type="password"  name="password" value={Input.password} placeholder="password" />
            <br /> <br/>
            <button id="ip_btn" className="btn btn-danger">SIGNIN</button> <br/>
